    ...
    functionDeclarations: [
      {
        ...
        description:
          'Search available menu items across partner restaurants matching cuisine, spice, budget, or name.',
        ...
        parameters: {
          ...
          properties: {
            query: {
              type: 'string',
              description:
                'Search keywords like spicy, pizza, burger, biryani',
            },
            ...
            isVeg: {
              type: 'boolean',
              description:
                'True for purely vegetarian items',
            },
...
7. NEVER invent menu item IDs, restaurant IDs, prices, or availability.

8. Financial actions always require human approval.
...
`;
    ...
    // ---------------------------------------------------------
      ...
      addAudit(
        'Direct Response',
        'Completed conversational response without external tool calls'
      );
    }
